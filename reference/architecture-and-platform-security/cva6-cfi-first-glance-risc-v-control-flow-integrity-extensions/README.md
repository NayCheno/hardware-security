...
- SOTA role: Academic SOTA for implementation and evaluation of RISC-V Zicfiss/Zicfilp control-flow-integrity extensions in CVA6.
...
适合作为 RISC-V CFI 的 SOTA 实现证据。局限是 arXiv、短评估、user-space benchmark，不能证明 TEE 或 confidential computing 安全。
<!-- END PAPER REVIEW -->
