...
- Evidence role: Background substrate. CXL memory-tier management background substrate; use for data-placement/fabric context, not as trusted-I/O proof.
## Review

Canonical BibTeX key: `zhong2024cxltiers`. Evidence role: Background substrate. CXL memory-tier management background substrate; use for data-placement/fabric context, not as trusted-I/O proof.
