...
- SOTA role: SoK/survey anchor and academic SOTA for accelerator TEE design taxonomy; use only for accelerator/device TEE discussions, not as a generic Arm CCA source.
...
- SOTA 定位: SoK/survey anchor; academic SOTA for accelerator TEE taxonomy
...
优点是方向贴近 SOTA，能补上通用 TEE survey 对加速器覆盖不足的问题；不足是无法替代原始系统论文或规范的机制细节。商业落地潜力高，但取决于设备厂商、IOMMU/TDISP/IDE/CoVE-IO 等标准和云平台编排栈是否协同成熟。
<!-- END PAPER REVIEW -->
