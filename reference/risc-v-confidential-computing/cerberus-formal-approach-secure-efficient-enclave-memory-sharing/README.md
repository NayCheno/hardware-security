...
- SOTA role: RISC-V/Keystone enclave memory-sharing baseline with formal SRE verification; useful for comparing CoVE shared-memory and CCA inter-CVM designs.
