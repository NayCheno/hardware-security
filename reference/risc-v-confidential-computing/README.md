...
8. `risc-v-ap-tee-specification/`
9. `risc-v-cove-io-specification/`
10. `ace-confidential-computing-embedded-risc-v-systems/`

## Indexed References

| Key | Reference | Status | Use in `domain.md` |
|---|---|---|---|
| `costan2016sanctum` | `sanctum-minimal-hardware-extensions-strong-software-isolation/` | USENIX Security 2016, local PDF available | Foundational RISC-V/open-hardware enclave baseline. |
...
| `bahmani2021cure` | `cure-customizable-resilient-enclaves/` | USENIX Security 2021/arXiv, local PDF available | RISC-V customizable enclave and peripheral-binding baseline. |
| `bourgeat2019mi6` | `mi6-secure-enclaves-speculative-out-of-order-processor/` | MICRO 2019/arXiv, local PDF available | RISC-V speculative OoO enclave and microarchitectural isolation baseline. |
...
| `riscv_ap_tee_2024` | `risc-v-ap-tee-specification/` | v0.7 draft / not ratified, local PDF available | Spec/industry SOTA for TVM/TSM/COVH/COVG lifecycle. |
| `riscv_cove_io_2026` | `risc-v-cove-io-specification/` | v0.3.0 draft / not ratified, local PDF available | Spec/industry SOTA for trusted I/O, DMA/MMIO, device identity, interrupt path. |
| `riscv_iommu_2023` | `risc-v-iommu-specification/` | v1.0.0 release, local PDF available | Base I/O translation/protection reference for CoVE-IO discussion. |
| `riscv_aia_2023` | `risc-v-advanced-interrupt-architecture/` | v1.0 release, local PDF available | Base interrupt architecture reference for trusted MSI / confidential I/O discussion. |
...
| `ozga2025ace` | `ace-confidential-computing-embedded-risc-v-systems/` | arXiv 2025, local PDF available | Embedded RISC-V confidential computing SOTA with auditable/formally oriented firmware. |
