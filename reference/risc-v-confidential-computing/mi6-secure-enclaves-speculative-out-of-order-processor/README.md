...
- SOTA role: RISC-V enclave baseline for speculative out-of-order cores and microarchitectural isolation; use when discussing side-channel limits of enclave designs.
