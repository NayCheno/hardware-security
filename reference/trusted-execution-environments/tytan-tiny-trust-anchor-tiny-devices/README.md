...
- SOTA 定位: 基础/历史入口：embedded dynamic trust anchor with real-time constraints
- 标准化 / 发表状态: peer-reviewed venue
- 对应小方向: RISC-V TEE lineage: Sanctum/Keystone/CURE/MI6/Penglai/SPEAR-V；Attestation、boot、lifecycle。
