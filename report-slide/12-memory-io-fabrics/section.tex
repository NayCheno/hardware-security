...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：本页只建立方向边界；性能数字分别来自三篇论文的摘要、Figure 6/10、Figure 5/10/12、Figure 7/9。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：重绘自 DirectCXL Figure 1 与 Figure 2-Figure 4；未复制原论文图片。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：矩阵依据 DirectCXL Section 1-2 的 related-work 分类和 Figure 1 的 RDMA 路径重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：机制图按 DirectCXL Figure 2-Figure 5 重绘，保留 HDM、switch、runtime 三个关键对象。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：实验图按 DirectCXL Figure 6、Figure 8/Table 2、Figure 10 的数字重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：评价结合 DirectCXL conclusion 与本仓库 evidence boundary，不添加论文未声称的安全结论。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：机制图重绘自 CXL-Tiers Figure 3、Figure 4 和 Figure 8。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：背景矩阵依据 CXL-Tiers Section 2 与 Figure 1-Figure 2 重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：控制回路按 CXL-Tiers Figure 8、Figure 9 和 Listing 1 重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：实验条形图按 CXL-Tiers abstract、Figure 5、Figure 10-Figure 12 和正文数值重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：评价基于 CXL-Tiers conclusion/discussion 和本仓库 background-substrate 证据边界。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：机制图按 ODRP Figure 3 和 Table 2 重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：矩阵重绘自 ODRP Table 1、Figure 1 和 Section 2.2-2.3。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：WR-chain 图按 ODRP Figure 4-Figure 6 和 Section 4.3-4.4 重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：实验图按 ODRP abstract、Figure 7、Figure 8、Figure 9 和正文数值重绘。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：评价依据 ODRP Section 4.5、Section 6、conclusion 与本仓库 confidential-I/O 证据边界。}}
\end{frame}
...
\end{columns}
\vspace{1mm}
{\tiny\textcolor{Muted}{引用依据：总结页使用三篇论文实验结果与证据等级边界。}}
\end{frame}
