...
AP-TEE/CoVE & TVM, TSM, memory lifecycle, and ABI direction for confidential VMs & Yes & AP-TEE v0.7 draft / CoVE proposal, not ratified & Core RISC-V confidential-VM direction. \\
CoVE-IO & Trusted I/O ABI, device identity, TDI lifecycle, trusted MMIO/DMA, and trusted MSI direction & Yes & CoVE-IO v0.3.0 draft, not ratified & Trusted-I/O direction for TVMs. \\ \bottomrule
\end{tabular}
\end{table*}
