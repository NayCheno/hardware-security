...
environment~\cite{sahita2023cove,riscv_ap_tee_2024,boubakri2025riscvtee}. This
distinction is important for classification: PMP-based enclaves, tagged-memory
enclaves, and CoVE-style TVMs share a motivation, but they do not expose the
same lifecycle, device, or attestation contract.
...
fresh, and tied to the execution context that will receive secrets~\cite{eat_rfc,menetrey2022attestation}.
