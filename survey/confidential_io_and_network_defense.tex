...
NIC-local root and function isolation & Can a SmartNIC/DPU isolate tenant functions or provide a trusted network primitive? & S-NIC, TNIC, vendor DPU OP-TEE/fTPM building blocks & Treat NICs and DPUs as explicit but incomplete trust endpoints that still need attestation, lifecycle, DMA, and channel binding. \\
...
Hazel, and BlueField OP-TEE/fTPM shows that device-local, NIC-local,
