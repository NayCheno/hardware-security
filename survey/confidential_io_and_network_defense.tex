...
Device-local confidential execution & Does the accelerator or offload engine hold secrets or execute trusted code? & ACAI, PORTAL, CAGE, StrongBox, ITX, HETEE, CloudScale, vendor BlueField OP-TEE/fTPM building blocks, accelerator TEE designs & Extend or avoid extending the TCB to accelerators and offload devices; do not treat vendor building blocks as complete confidential-networking TEEs. \\ \bottomrule
\end{tabular}
\end{table*}
