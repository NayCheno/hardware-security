...
| `abera2016cflat` | `local_pdf_verified` | `https://download.hrz.tu-darmstadt.de/pub/FB20/Dekanat/Publikationen/TRUST/c-flat-ccs-2016.pdf` | `pdftotext` page 1 shows title *C-FLAT: Control-Flow Attestation for Embedded Systems Software*, authors, CCS 2016, and DOI `10.1145/2976749.2978358`. |
| `dessouky2017lofat` | `local_pdf_verified` | `https://arxiv.org/pdf/1706.03754` | `pdftotext` page 1 shows title *LO-FAT: Low-Overhead Control Flow ATtestation in Hardware*, authors, and arXiv `1706.03754`; Aalto/Uni-Due metadata verify DAC 2017 and DOI `10.1145/3061639.3062276`. |
| `nunes2019vrased` | `local_pdf_verified` | `https://www.usenix.org/system/files/sec19-nunes.pdf` | `pdftotext` page 1 shows title *VRASED: A Verified Hardware/Software Co-Design for Remote Attestation*, authors, and 28th USENIX Security Symposium 2019. |
| `ferraiuolo2017komodo` | `local_pdf_verified` | `https://people.ece.cornell.edu/af433/pdf/ferraiuolo-sosp-17.pdf` | `pdfinfo` reports title *Komodo: Using verification to disentangle secure-enclave hardware from software*, authors, 19 pages; page text shows SOSP 2017 and DOI `10.1145/3132747.3132782`. |
