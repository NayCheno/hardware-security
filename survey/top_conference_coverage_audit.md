...
- Active BibTeX count after audit: 99.
- Excluded attack BibTeX count after audit: 64.
-正文 cited keys after audit: 97, all present in `survey/reference.bib`.
- Reference library status after audit: 97 paper/spec entry READMEs, 80 verified local PDFs.
